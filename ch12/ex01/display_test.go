...
func Example_arrayMap() {
	arrayMap1 := make(map[[3]string]string)
	arrayMap1[[3]string{"ABC", "DEF", "GHI"}] = "JKLMN"
	Display("arrayMap1", arrayMap1)
	arrayMap2 := make(map[[3]int]int)
	arrayMap2[[3]int{1, 2, 3}] = 4
	Display("arrayMap2", arrayMap2)
	// Output:
	// Display arrayMap1 (map[[3]string]string):
	// arrayMap1[[3]string{"ABC", "DEF", "GHI"}] = "JKLMN"
	// Display arrayMap2 (map[[3]int]int):
	// arrayMap2[[3]int{1, 2, 3}] = 4
}
...
func Example_structMap() {
	...
	structMap := make(map[ExampleStruct]int)
	structMap[ExampleStruct{"abc", 123}] = 456
	Display("structMap", structMap)
	// Output:
	// Display structMap (map[display.ExampleStruct]int):
	// structMap[display.ExampleStruct{strField: "abc", intField: 123}] = 456
}
